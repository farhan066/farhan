    ...
    <div class="wrapper">
      ...
      <div class="contact_footer fade_simple">
        <ul class="contact_footer_links">
          <li><a :href="'mailto:' + email" target="_blank" class="email"> {{ email }}<img class="arrow"
                src="@/assets/img/arrow.svg" /> </a></li>
        ...
        <p class="contact_footer_copywrite">Designed and developed by me <br> ©{{ currentYear }} - All Rights Reserved
        </p>
      </div>
    </div>
  </section>
